...
##변수 선언##
dice1,dice2,dice3,dice4,dice5,dice6=[0]*6   #주사위 6개의 숫자를 저장할 변수
throwCount,serialCount=0,0                  #전체 던진 횟수, 1~6이 연속으로 나온 횟수
...
if __name__=="__main__":
    while True:              #무한반복 수행
        throwCount+=1        #전체 던진 횟수를 1 증가시킨다

        dice1=random.randrange(1,7) #1부터 6까지 숫자 중 하나를 반
